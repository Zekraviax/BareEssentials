	...
	public static class RegistryEvents {
		...
		public static void registerBlocks(final RegistryEvent.Register<Block> event)
		{
			...
			(
				...
				// Rainbow Eucalyptus
				ModBlocks.RAINBOW_EUCALYPTUS_BUTTON = new EssentialButton(Block.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "rainbow_eucalyptus_button"),
				ModBlocks.RAINBOW_EUCALYPTUS_DOOR = new EssentialDoor().setRegistryName(MOD_ID, "rainbow_eucalyptus_door"),
				ModBlocks.RAINBOW_EUCALYPTUS_FENCE = new FenceBlock((Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD))).setRegistryName(MOD_ID, "rainbow_eucalyptus_fence"),
				ModBlocks.RAINBOW_EUCALYPTUS_FENCE_GATE = new FenceGateBlock(Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "rainbow_eucalyptus_fence_gate"),
				ModBlocks.RAINBOW_EUCALYPTUS_LEAVES = new LeavesBlock(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)).setRegistryName(MOD_ID, "rainbow_eucalyptus_leaves"),
				ModBlocks.RAINBOW_EUCALYPTUS_LOG = new LogBlock(MaterialColor.BROWN, Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(4.0F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "rainbow_eucalyptus_log"),
				ModBlocks.RAINBOW_EUCALYPTUS_PLANKS = new Block(Block.Properties.create(Material.WOOD, MaterialColor.ADOBE).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "rainbow_eucalyptus_planks"),
				ModBlocks.RAINBOW_EUCALYPTUS_PRESSURE_PLATE = new EssentialPressurePlate(PressurePlateBlock.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, MaterialColor.BROWN).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "rainbow_eucalyptus_pressure_plate"),
				ModBlocks.RAINBOW_EUCALYPTUS_SAPLING = new EssentialSapling(new RainbowEucalyptusTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.f).sound(SoundType.PLANT)).setRegistryName(MOD_ID, "rainbow_eucalyptus_sapling"),
				//ModBlocks.RAINBOW_EUCALYPTUS_SIGN = new StandingSignBlock(Block.Properties.create(Material.WOOD, MaterialColor.BROWN).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)).setRegistryName("rainbow_eucalyptus_sign"),
				ModBlocks.RAINBOW_EUCALYPTUS_SLAB = new SlabBlock(Block.Properties.create(Material.WOOD, MaterialColor.ADOBE).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "rainbow_eucalyptus_slab"),
				ModBlocks.RAINBOW_EUCALYPTUS_STAIRS = new EssentialStairs(ModBlocks.HOLLY_PLANKS.getDefaultState(), Block.Properties.from(ModBlocks.HOLLY_PLANKS)).setRegistryName(MOD_ID, "rainbow_eucalyptus_stairs"),
				ModBlocks.RAINBOW_EUCALYPTUS_TRAPDOOR = new EssentialTrapDoor().setRegistryName(MOD_ID, "rainbow_eucalyptus_trapdoor"),
				ModBlocks.RAINBOW_EUCALYPTUS_WOOD = new RotatedPillarBlock(Block.Properties.create(Material.WOOD, MaterialColor.ADOBE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName("rainbow_eucalyptus_wood"),
				ModBlocks.STRIPPED_RAINBOW_EUCALYPTUS_LOG = new LogBlock(MaterialColor.BROWN, Block.Properties.create(Material.WOOD, MaterialColor.ADOBE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "stripped_rainbow_eucalyptus_log"),
				ModBlocks.STRIPPED_RAINBOW_EUCALYPTUS_WOOD = new LogBlock(MaterialColor.BROWN, Block.Properties.create(Material.WOOD, MaterialColor.ADOBE).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName(MOD_ID, "stripped_rainbow_eucalyptus_wood"),
				// Wattle
		...
		public static void registerItems(final RegistryEvent.Register<Item> event)
		{
			...
			(
				...
				// Rainbow Eucalyptus
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_BUTTON, properties).setRegistryName("rainbow_eucalyptus_button"),
				new EssentialDoorItem(ModBlocks.RAINBOW_EUCALYPTUS_DOOR, properties).setRegistryName("rainbow_eucalyptus_door"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_FENCE, properties).setRegistryName("rainbow_eucalyptus_fence"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_FENCE_GATE, properties).setRegistryName("rainbow_eucalyptus_fence_gate"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_LEAVES, properties).setRegistryName("rainbow_eucalyptus_leaves"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_LOG, properties).setRegistryName("rainbow_eucalyptus_log"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_PLANKS, properties).setRegistryName("rainbow_eucalyptus_planks"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_PRESSURE_PLATE, properties).setRegistryName("rainbow_eucalyptus_pressure_plate"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_SAPLING, properties).setRegistryName("rainbow_eucalyptus_sapling"),
				//new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_SIGN, properties).setRegistryName("wattle_sign"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_SLAB, properties).setRegistryName("rainbow_eucalyptus_slab"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_STAIRS, properties).setRegistryName("rainbow_eucalyptus_stairs"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_TRAPDOOR, properties).setRegistryName("rainbow_eucalyptus_trapdoor"),
				new BlockItem(ModBlocks.RAINBOW_EUCALYPTUS_WOOD, properties).setRegistryName("rainbow_eucalyptus_wood"),
				new BlockItem(ModBlocks.STRIPPED_RAINBOW_EUCALYPTUS_LOG, properties).setRegistryName("stripped_rainbow_eucalyptus_log"),
				new BlockItem(ModBlocks.STRIPPED_RAINBOW_EUCALYPTUS_WOOD, properties).setRegistryName("stripped_rainbow_eucalyptus_wood"),
				// Wattle
